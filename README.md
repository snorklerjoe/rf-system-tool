...
- **IP3** is cascaded with worst-case phase-aligned voltage-domain addition, including cumulative linear gain terms (`rf_tool/engine/cascade.py`, `cascade_iip3`).
- **P1dB** is cascaded with reciprocal-power arithmetic using output-referred stage P1dB and downstream gains, then converted to input-referred total (`rf_tool/engine/cascade.py`, `cascade_p1db`).
